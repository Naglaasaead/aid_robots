...
class Patient2 extends StatefulWidget {
  const Patient2({Key? key});

  @override
  State<Patient2> createState() => _PatientState();
}

class _PatientState extends State<Patient2> {
  ...
  Future<void> retrievePatients() async {
    try {
      CollectionReference patientsRef = FirebaseFirestore.instance.collection('docPatient');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Patient of heart disease',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20)),
      ),
...
class _PatientState extends State<Patient2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Patients of Gynecology  ',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),),
      ),
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          showDialog(
