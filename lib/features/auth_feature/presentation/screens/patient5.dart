...
class Patient5 extends StatefulWidget {
  const Patient5({Key? key});

  @override
  State<Patient5> createState() => _PatientState();
}

class _PatientState extends State<Patient5> {
  ...
  Future<void> retrievePatients() async {
    try {
      CollectionReference patientsRef = FirebaseFirestore.instance.collection('docPatient4');
...
class _PatientState extends State<Patient5> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Patients of eyes ',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),),
      ),
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          showDialog(
