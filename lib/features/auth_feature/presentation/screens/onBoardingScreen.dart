            ...
            onSelected: (String value) {
              setState(() {
                ...
                if (value == 'Arabic') {
                  ...
                  context.read<LangCubit>().changeLang('en');
                }
              });
            },
...
import 'package:aid_robot/features/auth_feature/presentation/screens/role.dart';
import 'package:flutter/material.dart';
import 'package:easy_localization/easy_localization.dart'; // إضافة استيراد EasyLocalization
...
class _BoardingScreenState extends State<BoardingScreen> {
          ...
          PopupMenuButton<String>(
            ...
            onSelected: (String value) {
              setState(() {
                selectedLanguage = value;
                if (value == 'Arabic') {
                  context.setLocale(Locale('ar')); // تغيير اللغة في EasyLocalization
                } else {
                  context.setLocale(Locale('en')); // تغيير اللغة في EasyLocalization
                }
              });
            },
            itemBuilder: (BuildContext context) {
  ...
  Widget _buildPage(int index) {
    ...
    switch (index) {
      case 0:
        title = 'SeamlessDoctor'.tr();
        subTitle = 'Connections'.tr();
        imageUrl = 'assets/images/im1.png';
        break;
      case 1:
        title = 'MedicamentName'.tr();
        subTitle = '';
        imageUrl = 'assets/images/im2.png';
        break;
      default:
        title = 'FindPharmacies'.tr();
        subTitle = '';
        imageUrl = 'assets/images/im3.png';
        break;
    }
